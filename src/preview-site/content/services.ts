...
export const serviceTiers: ServiceTier[] = [
  {
    ...
    inclusions: [
      'Strategy call & written buying brief',
      'On-market and off-market search',
      'Due diligence on every shortlisted property',
      'Negotiation through to settlement (including auction when the purchase path requires it)',
    ],
    comparison: {
  ...
  },
  {
    ...
    comparison: {
      ...
      'Inspections & due diligence': true,
      'Negotiation': true,
      'Auction when required': 'If the campaign goes to auction',
